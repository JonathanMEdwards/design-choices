...
becomes a history of edit actions through which the document is performed. The representation erases
...
\item \emph{Materialized Execution.} Finally, a system can record every single step of the execution
  ...
  BootrstrapLab/MASP \cite{jakubovic-2022-bootstraplab}).
\end{itemize}
...
document-oriented programming systems, but not all. RekonPad~\cite{ohshima-2025-renkonpad}
